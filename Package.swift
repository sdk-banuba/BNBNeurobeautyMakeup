...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.1-73-g8d138045c3/BNBNeurobeautyMakeup.zip",
            checksum: "7d78f60429b8842db0b0c8ced288695f85117a3631c9f44593967b09f1de57f8"
        ),
        .target(
