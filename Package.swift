...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.3-95-g54f78c5d8b/BNBNeurobeautyMakeup.zip",
            checksum: "db5d53eceaf0b253b5e585d196a3471eee653689a72d83b95c9033a6634852bd"
        ),
        .target(
