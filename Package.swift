...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-38-g9a4283c65/BNBNeurobeautyMakeup.zip",
            checksum: "f0c8197d7557ba86011e51dc62452df96ae2611246a21f60637de6a23ed9d607"
        ),
        .target(
