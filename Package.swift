...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.0-9-g9cd2ba648/BNBNeurobeautyMakeup.zip",
            checksum: "ed1e04d696a4e202f0d23ce37c681a03aeff217261354306f0dc0524ac6b5002"
        ),
        .target(
