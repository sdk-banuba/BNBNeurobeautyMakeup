...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g2e0f1ab74/BNBNeurobeautyMakeup.zip",
            checksum: "4fe3f3c1bf907def65c18e51a24c9815fd8875666dd3ab8ed3b8c43dfdca85fd"
        ),
        .target(
