...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-71-g826381c83/BNBNeurobeautyMakeup.zip",
            checksum: "25eb50de9d3c9ab9fdcf851b25f45e77749d17b777527ace5872d932cc373038"
        ),
        .target(
