...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-69-g431d04ab4a/BNBNeurobeautyMakeup.zip",
            checksum: "13746fa5908a95fd1cba305e6a560da0bfba7739e226977824ec4cd2cfbcd207"
        ),
        .target(
