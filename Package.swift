...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.0-19-gb88228b6f/BNBNeurobeautyMakeup.zip",
            checksum: "b6b16313b575d0e93c8a6a290e8b141af7a8ae784a1292d6e80cd628b7a7aaeb"
        ),
        .target(
