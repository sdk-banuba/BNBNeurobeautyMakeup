...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBNeurobeautyMakeup",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.0-3-gb365c1950/BNBNeurobeautyMakeup.zip",
            checksum: "cd865fd3ab3daad3dbec1c55db007053a01cef72e085e95fa4875be3011ce9c0"
        ),
        .target(
